...
class BouncePostprocessor:
    def __init__(self, path_model=None, num_frame=3, threshold=0.45):
    ...
    def prepare_features(self, x_ball, y_ball):
        ...
        colnames_x = ['x_diff_{}'.format(i) for i in range(1, self.num_frame)] + \
                     ['x_diff_inv_{}'.format(i) for i in range(1, self.num_frame)] + \
                     ['x_div_{}'.format(i) for i in range(1, self.num_frame)]
        colnames_y = ['y_diff_{}'.format(i) for i in range(1, self.num_frame)] + \
                     ['y_diff_inv_{}'.format(i) for i in range(1, self.num_frame)] + \
                     ['y_div_{}'.format(i) for i in range(1, self.num_frame)]
